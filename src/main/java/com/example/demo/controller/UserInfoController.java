...
public class UserInfoController {
	...
	public String displayAdd(Model model) {
        List<Pk_region_mst> regionList = commonService.getRegionList();
        UserAddRequest userAddRequest = new UserAddRequest();
        userAddRequest.setRegionList(regionList);
	...
	public String displayEdit(@PathVariable String id, Model model) {
		...
		userUpdateRequest.setUser_name(user.getUser_name());
		userUpdateRequest.setPhone(user.getPhone());
		userUpdateRequest.setUser_address(user.getUser_address());
